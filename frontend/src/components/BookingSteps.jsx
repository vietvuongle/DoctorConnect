...
import { CalendarCheck as CalendarCheckIcon, UserCheck as UserCheckIcon, ClipboardCheck as ClipboardCheckIcon, CheckCircle as CheckCircleIcon } from "lucide-react";
        ...
        <section id="booking" className="py-16 bg-blue-50">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-gray-800 mb-4">Quy trình đặt lịch đơn giản</h2>
                    <p className="text-gray-600 max-w-2xl mx-auto">Chỉ với 4 bước đơn giản, bạn có thể đặt lịch khám tại phòng khám của chúng tôi một cách nhanh chóng và thuận tiện.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {steps.map((step, index) => (
                        <div key={index} className="bg-white p-6 rounded-lg shadow-sm text-center relative">
                            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-blue-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold">{index + 1}</div>
