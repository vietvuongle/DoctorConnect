...
export function Doctors() {
  ...
  const filteredDoctors = doctors.filter((doctor) => {
    ...
    const specialtyContainsQuery = doctor.specialty.toLowerCase().includes(searchQuery.toLowerCase())
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-8 text-center">
            <p className="text-gray-800 text-3xl font-semibold">
              Tìm kiếm và đặt lịch với bác sĩ chuyên khoa
            </p>
          </div>
          {/* Search and Filter */}
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                      <div className="flex items-center text-green-600">
                        ...
                        <span className="text-sm">
                          Lịch trống: {doctor.nextAvailable}
                        </span>
                      </div>
