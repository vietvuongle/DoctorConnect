...
const Sidebar = () => {
    ...
    const { cToken, setCToken } = useContext(ClinicContext);
    ...
    return (
        <div>
                ...
                <div className="lg:col-span-1 mt-5 ml-5 mr-5 md:flex md:w-60 md:flex-col">
                    <div className="rounded-lg shadow overflow-hidden">
                        <nav className="flex-1 px-2 pb-4 space-y-1.5">
                            ...
                            <NavLink to={"/admin/clinic"} className={({ isActive }) => `ml-1 group flex items-center px-2 py-2 text-sm font-medium rounded-md w-full ${isActive ? "bg-blue-100 text-blue-700" : "text-gray-600 hover:bg-gray-50"}`}>
                                <UserIcon className="mr-3 flex-shrink-0 h-6 w-6" />
                                <p className="hidden md:block">Phòng khám</p>
                            </NavLink>
            ...
            {dToken && (
                <div className="lg:col-span-1 mt-5 ml-5 mr-5 md:flex md:w-64 md:flex-col">
                    <div className="rounded-lg shadow overflow-hidden">
                        ...
                        <nav className="flex-1 px-4 space-y-1 my-4 ">
                            <NavLink to={"/doctor/dashboard"} className={({ isActive }) => `ml-1 group flex items-center px-2 py-2 text-sm font-medium rounded-md w-full ${isActive ? "bg-blue-100 text-blue-700" : "text-gray-600 hover:bg-gray-50"}`}>
                                <BarChartIcon className="mr-3 flex-shrink-0 h-6 w-6" />
                                <p className="hidden md:block">Dashboard</p>
                            </NavLink>
                            ...
                            <NavLink to={"/doctor/shedule"} className={({ isActive }) => `ml-1 group flex items-center px-2 py-3 text-sm font-medium rounded-md w-full ${isActive ? "bg-blue-100 text-blue-700" : "text-gray-600 hover:bg-gray-50"}`}>
                                <CalendarIcon className="mr-3 flex-shrink-0 h-6 w-6" />
                                <p className="hidden md:block">Tạo lịch khám</p>
                            </NavLink>
                            ...
                            <NavLink to={"/doctor/change-password"} className={({ isActive }) => `ml-1 group flex items-center px-2 py-3 text-sm font-medium rounded-md w-full ${isActive ? "bg-blue-100 text-blue-700" : "text-gray-600 hover:bg-gray-50"}`}>
                                <SettingsIcon className="mr-3 flex-shrink-0 h-6 w-6" />
                                <NavLink to={"/clinic/setting"} className={({ isActive }) => `ml-1 group flex items-center px-2 py-2 text-sm font-medium rounded-md w-full ${isActive ? "bg-blue-100 text-blue-700" : "text-gray-600 hover:bg-gray-50"}`}>
                                    <SettingsIcon className="mr-3 flex-shrink-0 h-6 w-6" />
                                    <p className="hidden md:block">Cài đặt</p>
                                </NavLink>{" "}
                                <p className="hidden md:block">Đổi mật khẩu</p>
                            </NavLink>
                ...
                <div className="lg:col-span-1 mt-5 ml-5 mr-5 md:flex md:w-60 md:flex-col">
                    <div className="rounded-lg shadow overflow-hidden">
                        <nav className="flex-1 px-2 pb-4 space-y-1.5">
                            ...
                            <NavLink to={"/clinic/patient"} className={({ isActive }) => `ml-1 group flex items-center px-2 py-2 text-sm font-medium rounded-md w-full ${isActive ? "bg-blue-100 text-blue-700" : "text-gray-600 hover:bg-gray-50"}`}>
                                <UsersIcon className="mr-3 flex-shrink-0 h-6 w-6" />
                                <p className="hidden md:block">Bệnh nhân</p>
                            </NavLink>
