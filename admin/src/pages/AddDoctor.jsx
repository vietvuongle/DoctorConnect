        ...
        <div className='bg-white px-8 border py-8 rounded w-full max-w-4xl  overflow-y-scroll'>
          ...
          <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
            <div className='w-full lg:flex-1 flex flex-col gap-4'>
              ...
              <div className='flex-1 flex flex-col gap-1'>
                <p>Phí</p>
                <input onChange={(e) => setFees(e.target.value)} value={fees} className='border rounded px-3 py-2' type="number" placeholder='Phí Khám Bệnh' required />
              </div>
            ...
            <div className='w-full lg:flex-1 flex flex-col gap-4'>
              <div className='flex-1 flex flex-col gap-1'>
                ...
                <select onChange={(e) => setSpeciality(e.target.value)} value={speciality} className='border rounded px-3 py-2' name="" id="">
                  ...
                  <option value="Cơ xương khơp">Cơ xương khơp</option>
